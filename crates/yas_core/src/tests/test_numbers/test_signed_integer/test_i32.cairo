mod TestInteger32 {
    mod ConvertI32toU8 {
        ...
        use yas_core::numbers::signed_integer::{
            i32::{i32, i32TryIntou8}, integer_trait::IntegerTrait
        };
    ...
    mod ConvertU8toI32 {
        ...
        use yas_core::numbers::signed_integer::{i32::{i32, u8Intoi32}, integer_trait::IntegerTrait};
    ...
    mod ConvertI32toU32 {
        ...
        use yas_core::numbers::signed_integer::{
            i32::{i32, i32TryIntou32}, integer_trait::IntegerTrait
        };
    ...
    mod ConvertI32toU128 {
        ...
        use yas_core::numbers::signed_integer::{
            i32::{i32, i32TryIntou128}, integer_trait::IntegerTrait
        };
    ...
    mod ModI32 {
        use yas_core::numbers::signed_integer::{i32::{i32, mod_i32}, integer_trait::IntegerTrait};
