...
fn SWAP_EXPECTED_RESULTS_POOL_2() -> Array<SwapExpectedResults> {
    array![
		...
		SwapExpectedResults {
			...
			execution_price: 119642528241237560407598554831,
		...
		SwapExpectedResults {
			...
			execution_price: 39217940444560847089789496412,
		...
		SwapExpectedResults {
			...
			execution_price: 55462543265038278420760100066,
		...
		SwapExpectedResults {
			...
			execution_price: 113177315100578060647420666263,
			fee_growth_global_0_X128_delta: 0,
		...
		SwapExpectedResults {
			...
			execution_price: 80109365535150998576787339612,
			fee_growth_global_0_X128_delta: 0,
		...
		SwapExpectedResults {
			...
			execution_price: 78288698136624839519700515832,
		...
		SwapExpectedResults {
			...
			execution_price: 126536085037902995675823286947,
			fee_growth_global_0_X128_delta: 0,
		...
		SwapExpectedResults {
			...
			execution_price: 49607206778259490326122741765,
