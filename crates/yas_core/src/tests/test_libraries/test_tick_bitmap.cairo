mod TickBitmapTests {
    use yas_core::libraries::tick_bitmap::TickBitmap;
    use yas_core::libraries::tick_bitmap::TickBitmap::TickBitmapImpl;
    ...
    mod IsInitialized {
        ...
        use yas_core::libraries::tick_bitmap::TickBitmap::{TickBitmapImpl, InternalImpl};
        use yas_core::numbers::signed_integer::{i32::i32, integer_trait::IntegerTrait};
    ...
    mod Position {
        use yas_core::libraries::tick_bitmap::TickBitmap;
        use yas_core::numbers::signed_integer::{i16::i16, i32::i32, integer_trait::IntegerTrait};
