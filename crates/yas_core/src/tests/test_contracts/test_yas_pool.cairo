mod YASPoolTests {
    ...
    fn setup() -> (
        ...
        let yas_router_2: IYASRouterDispatcher = deploy_yas_router_2(); // 0x1
        ...
        token_1.approve(yas_router_2.contract_address, BoundedInt::max());
        token_0.approve(yas_router_2.contract_address, BoundedInt::max());
        ...
        let (min_tick, max_tick) = get_min_tick_and_max_tick();
        set_contract_address(WALLET());
        yas_router_2.mint(yas_pool_address, WALLET(), min_tick, max_tick, 3161);

        (yas_pool, token_0, token_1, yas_router_2, min_tick, max_tick)
    }
    ...
    fn deploy_yas_router_2() -> IYASRouterDispatcher {
        let (address, _) = deploy_syscall(
