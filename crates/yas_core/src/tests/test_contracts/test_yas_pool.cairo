mod YASPoolTests {
    ...
    mod Swap {
        ...
        fn assert_swap_result_equals(
            ...
            get_significant_figures(actual.pool_price_after, presicion).print();
