mod YASPoolTests {
    ...
    mod Swap {
        ...
        mod PoolCase8 {
            ...
            fn test_pool_8_panics_0() {
                ...
                let expected_cases =
                    SWAP_EXPECTED_RESULTS_POOL_8(); //get random case, is never executed
                test_pool(
                    pool_case,
                    array![*expected_cases[PANIC_CASE]],
                    array![*panic_swap_cases[PANIC_CASE]],
        ...
        fn assert_swap_result_equals(
            ...
            // get_significant_figures(actual.pool_price_after, precision).print();
            // get_significant_figures(*expected.pool_price_after, precision).print();
    ...
    fn swap_test_case(
        ...
        if amount_specified.is_non_zero() {
            yas_router
                .swap(
                    yas_pool.contract_address,
                    WALLET(),
