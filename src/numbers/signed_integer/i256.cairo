...
fn i256_new(mag: u256, sign: bool) -> i256 {
    if sign == true {
        assert(
            mag <= 57896044618658097711785492504343953926634992332820282019728792003956564819968_u256,
            'int: out of range'
        );
    } else {
        assert(
            mag <= 57896044618658097711785492504343953926634992332820282019728792003956564819967_u256,
            'int: out of range'
        );
    }
    i256 { mag, sign }
