...
mod TickBitmap {
    ...
    impl TickBitmapImpl of ITickBitmap<ContractState> {
        ...
        fn flip_tick(ref self: ContractState, tick: i32, tick_spacing: i32) {
            ...
            let hashed_word_pos = self.generate_hashed_word_pos(@word_pos);
        ...
        fn next_initialized_tick_within_one_word(
            ...
            if lte {
                ...
                let word: u256 = self.bitmap.read(self.generate_hashed_word_pos(@word_pos));
                ...
                let (word_pos, bit_pos) = self
                    .position(compressed + IntegerTrait::<i32>::new(1, false));
                let word = self.bitmap.read(self.generate_hashed_word_pos(@word_pos));
    ...
    impl InternalImpl of InternalTrait {
        fn generate_hashed_word_pos(self: @ContractState, word_pos: @i16) -> felt252 {
        ...
        fn calculate_word(self: @ContractState, tick: i32) -> i16 {
        ...
        fn calculate_bit(self: @ContractState, tick: i32) -> u8 {
        ...
        fn position(self: @ContractState, tick: i32) -> (i16, u8) {
            let word_pos: i16 = self.calculate_word(tick);
            let bit_pos: u8 = self.calculate_bit(tick);
            (word_pos, bit_pos)
        }
