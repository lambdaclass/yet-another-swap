mod TestSwapMath { 
    ...
    mod ComputeSwapStep {
        ...
        use fractal_swap::numbers::fixed_point::implementations::impl_64x96::{
            FP64x96Impl, FP64x96PartialEq, FP64x96PartialOrd, FP64x96Div, FixedType, FixedTrait, Q96_RESOLUTION, ONE, MAX
        };
        ...
        //     assert(amount_in + fee_amount < SwapMath::i256_into_u256(amount), 'entire amount is not used');
        ...
        //     assert(sqrtQ < price_after_whole_input_amount, 'price < price after whole input'); // price is less than price after whole input amount
        // }    
        ...
        //     let price_after_whole_import_amount_less_fee = SqrtPriceMath::get_next_sqrt_price_from_input(price, liquidity, SwapMath::i256_into_u256(amount) - fee_amount, zero_for_one);

        //     assert(sqrtQ < price_target, 'price is capped at price target');
        //     assert(sqrtQ == price_after_whole_import_amount_less_fee, 'price = p_after_amount_less_fee'); // price is less than price after whole input amount
        // }    
        ...
        //     assert(sqrtQ == price_after_whole_output_amount, 'price = price after whole input'); // price is less than price after whole input amount
        // }
